...
*/    
    $cuenta1 = new CuentaBancaria(0010,$persona1->nombre,10000);
    $cuenta2 = new CuentaBancaria(0015,$persona2->nombre,0);
    $cuenta3 = new CuentaBancaria(0020,$persona3->nombre,100000);
/*
