<?php
    ...
    if (isset($_POST["enviar"])){
        if (!empty($_POST["cantidad_dias"]) && !empty($_POST["promedio_promocion"]) && !empty($_POST["promedio_regularidad"]) && !empty($_POST["edad_minima"]) && !empty($_POST['tolerancia'])){
           ...
           $parametro = Parametro::modificarParametros($cantidad_dias,$promedio_promocion,$promedio_regularidad,$edad_minima,$tolerancia);
